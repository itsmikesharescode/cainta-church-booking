...
CREATE OR REPLACE FUNCTION "public"."get_user_church_reservations_data"("church_id" bigint) RETURNS SETOF "public"."reservations_tb"
    LANGUAGE "plpgsql"
    AS $$
begin
    return query
...
ALTER FUNCTION "public"."get_user_church_reservations_data"("church_id" bigint) OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."get_user_church_reservations_data"("church_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_church_reservations_data"("church_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_church_reservations_data"("church_id" bigint) TO "service_role";
